Create a script that parses the /etc/passwd file and creates a hash with only the accounts that have /bin/bash listed as their shell. Use the UID as the key value, and the username as the hash value.
